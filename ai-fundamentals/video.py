...
def create_ai_fundamentals_video():
    """
    Creates scenes manually, with renamed titles based on the final voiceover text.
    """
    scenes = [
        Scene(
            name="Algorithmic Universe",
            duration=16,
        ...
        Scene(
            name="Object Recognition Example",
            duration=14,
